...
for epoch in range(epochs):
    ...
    for batch in train_progress:
        ...
        x = batch[:, :480, :]  # (batch_size, 30, 4)
        # Target: Last 4 timesteps of [highPrice, lowPrice]
        y = batch[:, 480:, :2]  # (batch_size, 4, 2)
    ...
    model_filename = f"OSRS_PricePredictorLong6hMSE_epoch_{epoch+1}.pth"
    torch.save(model.state_dict(), model_filename)

torch.save(model.state_dict(), "OSRS_PricePredictorLong6hMSE.pth")
wandb.finish()